          ...
          <div className="w-full lg:w-7/12 flex flex-col items-start">
            ...
            <div className="mt-8 mb-6">
              <p className="text-text-main text-base md:text-lg leading-loose">
                「人前で気兼ねなく笑いたい」<br className="hidden sm:block" />
                その願いを叶えるためには、トラブルが起きてからではなく、健康な状態をいかに維持するかが鍵となります。<br />
                私たちは、歯周病学会認定医として培った専門性を軸に、患者さまとじっくり向き合う診療を心がけています。<br />
                治療内容と費用は事前に書面でお渡しし、納得いただいてから処置を始めます。キッズスペースや女性歯科医師の在籍など、お子さま連れでも通いやすい環境を整えています。
              </p>
            </div>
