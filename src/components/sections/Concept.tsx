          ...
          <div className="mt-10 md:mt-14 max-w-[var(--width-content)] w-full relative">
            <div className="flex flex-col gap-6 text-text-main leading-loose text-base md:text-lg">
              <p>
                ...
                これまでの歯科医院は、多くの方にとって「できれば行きたくない場所」でした。あおば歯科・矯正歯科が目指すのは、そのネガティブなイメージを払拭し、美容院やカフェのように、ご自身のメンテナンスのために心地よく通っていただけるクリニックです。
              </p>
              <p>
                私たちは、一時的な治療で終わるのではなく、10年後、20年後もご自身の歯で美味しく食事ができるよう「予防」を第一に考えています。<br className="hidden md:block" />
