...
export const metadata: Metadata = {
  title: "院長・スタッフ紹介",
  description: "あおば歯科・矯正歯科の院長・スタッフ紹介。日本歯周病学会認定医の院長 青葉健一の経歴と診療方針、副院長・歯科衛生士・受付スタッフの専門分野や患者さまとの向き合い方を写真とプロフィールで詳しくご紹介します。",
...
const staffs = [
  ...
  },
  {
    ...
    motto: "「自分でも続けられる」セルフケアの形を、一緒に見つけるお手伝いを。",
  },
  {
    role: "歯科衛生士",
    name: "田中 結菜",
    description: "明るい笑顔がトレードマーク。患者さまの不安を和らげるコミュニケーションを大切にしています。",
    motto: "ささいなお悩みでも、お話ししやすい雰囲気づくりを心がけます。",
  },
  {
    role: "受付・歯科助手",
    name: "鈴木 加奈",
      ...
      <section className="py-12 md:py-16">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="lg:w-2/3">
            <SectionHeading en="Director Message" ja="院長ご挨拶" align="left" level={1} />
            <div className="mt-8 space-y-6 text-text-main leading-loose">
              ...
              <p>
                2018年、地元であるこの場所に開業した理由は、専門的な治療技術はもちろん、日々の些細な変化を共に分かち合える「一生涯のパートナー」としての歯科医院を作りたいと考えたからです。初診カウンセリングに30分を確保し、ご希望や不安を伺ったうえで治療計画をお伝えする運用も、この考えに基づいています。
              </p>
              <p>
                10年後、20年後も、あなたが大好きなものを美味しく食べ続けられるよう、共にお口の健康を守っていければ幸いです。
              </p>
            </div>
