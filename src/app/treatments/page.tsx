...
const treatments = [
  ...
  },
  {
    ...
    description: "お子さまのペースに合わせた診療を行います。無理に治療を進めるのではなく、まずは雰囲気に慣れてもらうことからスタート。乳歯から永久歯への生え変わり時期に合わせて、虫歯予防と歯並びのチェックを継続的にサポートします。",
  ...
  },
  {
    ...
    name: "矯正歯科",
    en: "Orthodontics",
    description: "見た目の改善だけでなく、噛み合わせを整えることで、頭痛・肩こり・顎への負担といった症状の軽減も目指します。目立ちにくいマウスピース型矯正（インビザライン等）や、お子さまの成長に合わせた小児矯正も行っています。",
